...
public class ElasticSearchTransportClient implements ElasticSearchClient {
    ...
    public void addEvent(Event event, IndexNameBuilder indexNameBuilder, String indexType, long ttlMs) throws Exception {
        ...
        if (indexRequestBuilderFactory == null) {
            indexRequestBuilder = client.prepareIndex(indexNameBuilder.getIndexName(event), indexType).setSource(
     ...
     * FOR TESTING ONLY...
     * 
     * Opens a local discovery node for talking to an elasticsearch server running in the same JVM
     */
